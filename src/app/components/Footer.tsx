...
const Footer = () => {
  return (
    <div className="mt-1 flex flex-col items-center gap-6 md:flex-row md:items-start md:justify-between md:gap-8 bg-[#eaf1f2] p-8 rounded-lg">
      ...
      <div className="flex flex-col gap-4 text-sm text-gray-400 items-center md:items-start">
        <p className="text-sm text-amber-50 text-black"> Links </p>
